...
export default function AdminPage(){
    ...
    var getUrlForStadiums = useCallback(() => {
        return "https://Matyas-Andras-SDI-Lab.chickenkiller.com/api/stadiums/?page=" + String(pageNumber) + "&pageNumber=" + String(paginationValue);
        // return "http://localhost:8000/api/stadiums/?page=" + String(pageNumber) + "&pageNumber=" + String(paginationValue);
    }, [pageNumber, paginationValue])

    var getUrlForClubs = useCallback(() => {
        return "https://Matyas-Andras-SDI-Lab.chickenkiller.com/api/clubs/?page=" + String(pageNumber) + "&pageNumber=" + String(paginationValue);
        // return "http://localhost:8000/api/clubs/?page=" + String(pageNumber) + "&pageNumber=" + String(paginationValue);
    }, [pageNumber, paginationValue])
    
    var getUrlForCompetitions = useCallback(() => {
        return "https://Matyas-Andras-SDI-Lab.chickenkiller.com/api/competitions/?page=" + String(pageNumber) + "&pageNumber=" + String(paginationValue);
        // return "http://localhost:8000/api/competitions/?page=" + String(pageNumber) + "&pageNumber=" + String(paginationValue);
    }, [pageNumber, paginationValue])

    var getUrlForMatches = useCallback(() => {
        return "https://Matyas-Andras-SDI-Lab.chickenkiller.com/api/matches/?page=" + String(pageNumber) + "&pageNumber=" + String(paginationValue);
        // return "http://localhost:8000/api/matches/?page=" + String(pageNumber) + "&pageNumber=" + String(paginationValue);
    }, [pageNumber, paginationValue])
    ...
    useEffect(() => {
        if (stadiumListVisible){
            ...
            setDeleteMatchList([]);
            fetch("https://Matyas-Andras-SDI-Lab.chickenkiller.com/api/stadiums/?pageNumber=" + String(paginationValue))
            // fetch("http://localhost:8000/api/stadiums/?pageNumber=" + String(paginationValue))
        ...
        if (clubListVisible){
            ...
            setDeleteCompetitionList([]);
            setDeleteMatchList([]);
            fetch("https://Matyas-Andras-SDI-Lab.chickenkiller.com/api/clubs/?pageNumber=" + String(paginationValue))
            // fetch("http://localhost:8000/api/clubs/?pageNumber=" + String(paginationValue))
                .then(number => number.json())
                .then(number => setPageMax(number["pageNumber"]));
        }
        if (competitionListVisible){
            ...
            setDeleteStadiumList([]);
            setDeleteMatchList([]);
            fetch("https://Matyas-Andras-SDI-Lab.chickenkiller.com/api/competitions/?pageNumber=" + String(paginationValue))
            // fetch("http://localhost:8000/api/competitions/?pageNumber=" + String(paginationValue))
                .then(number => number.json())
                .then(number => setPageMax(number["pageNumber"]));
        }
        if (matchListVisible){
            ...
            setDeleteCompetitionList([]);
            setDeleteStadiumList([]);
            fetch("https://Matyas-Andras-SDI-Lab.chickenkiller.com/api/matches/?pageNumber=" + String(paginationValue))
            // fetch("http://localhost:8000/api/matches/?pageNumber=" + String(paginationValue))
                .then(number => number.json())
                .then(number => setPageMax(number["pageNumber"]));
        }
    ...
    const stadiumDeleteButtonHandler = () => {
        ...
        const URL = "https://Matyas-Andras-SDI-Lab.chickenkiller.com/api/admin/stadiums/";
        // const URL = "http://localhost:8000/api/admin/stadiums/";
    ...
    const clubDeleteButtonHandler = () => {
        ...
        const URL = "https://Matyas-Andras-SDI-Lab.chickenkiller.com/api/admin/clubs/";
        // const URL = "http://localhost:8000/api/admin/clubs/";
        fetch(URL, requestOptions)
            .then(() => {refreshPages();});
    }
    ...
    const competitionDeleteButtonHandler = () => {
        ...
        const URL = "https://Matyas-Andras-SDI-Lab.chickenkiller.com/api/admin/competitions/";
        // const URL = "http://localhost:8000/api/admin/competitions/";
        fetch(URL, requestOptions)
            .then(() => {refreshPages();});
    }
    ...
    const matchDeleteButtonHandler = () => {
        ...
        const URL = "https://Matyas-Andras-SDI-Lab.chickenkiller.com/api/admin/matches/";
        // const URL = "http://localhost:8000/api/admin/matches/";
        fetch(URL, requestOptions)
            .then(() => {refreshPages();});
    }
